...
Adhearsion.config do |config|
  ...
  config.adhearsion_drb.shared_object = ClickToCall.new
end
...
Adhearsion.router do
  route 'Demo Controller', DemoController, :to => '1'
  route 'Simple controller', SimpleController, :to => '2'
  route 'Billing controller', BillingController, :to => '3'
  route 'Outbound Notification', ConnectingController, Adhearsion::OutboundCall
end
  #p $LOADED_FEATURES.size; exit 1
